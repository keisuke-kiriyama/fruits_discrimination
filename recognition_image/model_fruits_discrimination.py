...
def deep_inference(images_placeholder, keep_prob, image_size, num_classes):
    x_image = tf.reshape(images_placeholder, [-1, image_size, image_size, 3])
    # print(x_image)
    ...
    with tf.name_scope('fc1') as scope:
        ...
        W_fc1 = weight_variable([int(w * w * 128), 1024])
        b_fc1 = bias_variable([1024])
        h_pool3_flat = tf.reshape(h_pool3, [-1, int(w * w * 128)])
...
def texture_inference(images_placeholder, keep_prob, image_size, num_classes):
    x_image = tf.reshape(images_placeholder, [-1, image_size, image_size, 3])
    #print(x_image)
    ...
    with tf.name_scope('conv2') as scope:
        W_conv2 = weight_variable([5, 5, 3, 64])
        b_conv2 = bias_variable([64])
